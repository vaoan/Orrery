// GENERATED by orrery reconcile from aeleos 5e70a21 and libra 1c79de72 on 2026-09-10.
...
export const rules = {
  source: (body) => ({
    ...
    "no-regex-spaces": [2],
    "no-restricted-imports": ["error", { "patterns": [{ "group": ["../*"] }, ...body.imports.restrictedPatterns] }],
    "no-restricted-properties": ["error", { "object": "document", "property": "querySelector" }, { "object": "document", "property": "querySelectorAll" }],
    "no-restricted-syntax": [2, { "message": "Do not access flags[FeatureFlag.X] directly. Use hasFlag(FeatureFlag.X, flags) or useHasFlag(FeatureFlag.X). See: shared/application/utils/featureFlagChecks.ts", "selector": "MemberExpression[computed=true][object.name='flags'][property.type='MemberExpression'][property.object.name='FeatureFlag']" }, { "message": "Do not access flags.showXxx directly. Use hasFlag(FeatureFlag.X, flags) or useHasFlag(FeatureFlag.X). See: shared/application/utils/featureFlagChecks.ts", "selector": "MemberExpression[computed=false][object.name='flags'][property.name=/^show/]" }],
  ...
  "unit-test": (body) => ({
    ...
    "no-redeclare": [0, { "builtinGlobals": true }],
    "no-regex-spaces": [2],
    "no-restricted-syntax": [1, { "message": "Use queryByTestId (or role-based test id wrappers) instead of queryByText to avoid text/i18n-coupled assertions.", "selector": "CallExpression[callee.property.name='queryByText']" }, { "message": "Use queryByTestId (or role-based test id wrappers) instead of queryByText to avoid text/i18n-coupled assertions.", "selector": "CallExpression[callee.name='queryByText']" }],
    "no-self-assign": [2, { "props": true }],
    "no-setter-return": [0],
    "no-shadow-restricted-names": [2, { "reportGlobalThis": false }],
    "no-sparse-arrays": [2],
  ...
  package: (body) => ({
    ...
    "no-restricted-syntax": [2, { "message": "Avoid arbitrary Tailwind values (e.g. text-[10px], w-[347px]). Use semantic design tokens or Tailwind defaults instead. See: .claude/rules/tailwind.md", "selector": "JSXAttribute[name.name='className'] Literal[value=/\\w+\\-\\[\\d+[a-z]*\\]/]" }, { "message": "Avoid arbitrary color values (e.g. bg-[#f5f5f5]). Use semantic color tokens (bg-primary, text-muted-foreground, etc.) instead. See: .claude/rules/single-source-of-truth.md", "selector": "JSXAttribute[name.name='className'] Literal[value=/(bg|text|border|ring|outline|shadow|from|to|via)\\-\\[#[0-9a-fA-F]+\\]/]" }],
    "no-self-assign": [2, { "props": true }],
    "no-setter-return": [0],
    "no-shadow-restricted-names": [2, { "reportGlobalThis": false }],
    "no-sparse-arrays": [2],
