...
const classRules = {
  ...
  "e2e": (body) => ({
    ...
    "playwright/no-duplicate-hooks": [1],
    "playwright/no-duplicate-slow": [1],
    ...
    "playwright/no-wait-for-selector": [1],
    "playwright/no-wait-for-timeout": [2],
    "playwright/prefer-hooks-in-order": [1],
    "playwright/prefer-hooks-on-top": [1],
  ...
  package: (body) => ({
    ...
    "better-tailwindcss/no-unnecessary-whitespace": [1, { "allowMultiline": true, "entryPoint": "apps/store/src/app/globals.css" }],
    "boundaries/dependencies": ["error", { "default": "disallow", "rules": body.boundaries.allow }],
    "boundaries/no-unknown": [2],
    "boundaries/no-unknown-files": [2],
    "i18next/no-literal-string": [2],
